...
class PretrainESM_Model(nn.Module):
    def __init__(self, args):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained("facebook/esm2_t33_650M_UR50D",cache_dir="main/results/")
        self.model = EsmForMaskedLM.from_pretrained("facebook/esm2_t33_650M_UR50D",cache_dir="main/results/")
...
if __name__ == '__main__':
    tokenizer = AutoTokenizer.from_pretrained("facebook/esm2_t33_650M_UR50D",cache_dir="main/results/")
